...
class TakeoverViewModel: ObservableObject {
    ...
    @Published var swarmDevices: [DeviceSwarm.SwarmDevice] = []
    ...
    init() {
        ...
        #if os(iOS)
        let type: DeviceSwarm.SwarmDevice.DeviceType = .iPhone
        let name = UIDevice.current.name
        #else
        let type: DeviceSwarm.SwarmDevice.DeviceType = .mac
        let name = "This Mac"
        #endif
        
        swarmDevices = [
            DeviceSwarm.SwarmDevice(
                id: "local",
                name: name,
                type: type,
                memoryGB: memoryGB,
    ...
    func scanForDevices() {
        ...
        Task {
            ...
            let newDevice = DeviceSwarm.SwarmDevice(
                id: UUID().uuidString,
                name: "iPad Pro",
                type: .iPad,
                memoryGB: 16,
